...
Func _DoGUI()
	...
	Local $_check_LootPalace = GUICtrlCreateCheckbox("LootPalace", 232, 88, 121, 17)
	$USER_LootPalace = GUICtrlCreateInput($USER_LootPalace, 248, 112, 169, 21)
	$PASS_LootPalace = GUICtrlCreateInput($PASS_LootPalace, 248, 136, 169, 21)
	Local $_check_instaGC = GUICtrlCreateCheckbox("instaGC", 232, 168, 121, 17)
	$USER_instaGC = GUICtrlCreateInput($USER_instaGC, 248, 192, 169, 21)
	$PASS_instaGC = GUICtrlCreateInput($PASS_instaGC, 248, 216, 169, 21)
	...
	GUICtrlSetState($_check_LootPalace, $CHECK_LootPalace)
	GUICtrlSetState($_check_instaGC, $CHECK_instaGC)
	...
	While 1
		Switch GUIGetMsg()
			Case $buttonGo
				...
				_WriteLogin('LootPalace', $_check_LootPalace)
				_WriteLogin('instaGC', $_check_instaGC)
